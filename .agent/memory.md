...
- **Tech Stack:** Vite, React 19, TypeScript, **React Compiler**, shadcn-ui, Tailwind CSS, TanStack Query, React Router Dom 6.
...
- **Component Strategy:**
  ...
  - Includes a `Snake.tsx` mini-game component for interactivity.
- **Routing:**
  - `/`: Home/Portfolio page.
...
- **Snake Game Integration:** Renamed the `App` component in `Snake.js` to `SnakeGame` to avoid collision and integrated it as a top-level route `/snake`.
...
- **2025-12-24:** Integrated Snake game into the application with `/snake` route and navigation link.
